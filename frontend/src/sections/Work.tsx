    ...
    <section className="section section--dark" id="work">
      <div className="container">
        <SectionHeader
          ...
          text="На главной показываем только сильную подборку. Полная галерея разложена по маркам автомобилей, чтобы клиент мог быстро найти похожий пример."
        />
        ...
        <div className="work-archive-note">
          <p>Откройте галерею, выберите марку автомобиля и посмотрите монтажные решения на похожих машинах.</p>
