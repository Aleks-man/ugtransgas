  ...
  return (
    <section className="section" id="services">
      <div className="container">
        <SectionHeader
          eyebrow="Что делаем"
          title="Все необходимое для установки и обслуживания ГБО"
          text="От подбора оборудования и аккуратного монтажа до диагностики, обслуживания и освидетельствования баллонов — все работы выполняются в одном сервисе."
        />
        <div className="equipment-band">
          <img
            src={equipmentBackground}
            alt="Газобаллонное оборудование в сервисной зоне"
          />
